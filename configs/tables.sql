...
CREATE TABLE IF NOT EXISTS `volunteers` (
  ...
  `consent_processing_of_personal_data` binary(1) NOT NULL DEFAULT '1' COMMENT '''zgoda na przetwarzanie danych, wymagana do rejestracji w systemie.''',
  ...
  `accept_of_sending_data_to_WOSP` binary(1) NOT NULL DEFAULT '1' COMMENT '''zgoda na przekazanie danych do Fundacji WOSP, wymagana do rejestracji w systemie.''',
